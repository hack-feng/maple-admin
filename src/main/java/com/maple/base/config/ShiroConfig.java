...
import com.maple.base.filter.CustomRolesAuthorizationFilter;
import com.maple.base.util.ShiroUtil;
...
public class ShiroConfig {
    ...
    @Bean("shiroFilter")
    public ShiroFilterFactoryBean factory(DefaultWebSecurityManager securityManager, ShiroUtil shiroService) {
